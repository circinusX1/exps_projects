...
/*!
 * @brief BMP085 i2c_senz_c address/bits
 */
#define BMP085_ADDRESS (0x77)

/*!
 * @brief BMP085 i2c_senz_c registers
 */
enum {
...
public:
  ...
  /*!
   * @brief Starts i2c_senz_c connection
   * @param mode Mode to set, ultra high-res by default
   * @return Returns true if successful
   */
  bool begin(int sda=4, int scl=5, bmp085_mode_t mode = BMP085_MODE_ULTRAHIGHRES);
  /*!
   * @brief Gets the temperature over i2c_senz_c from the BMP085
   * @param temp Temperature
   * @return Returns the temperature
   */
  void getTemperature(float *temp);
  /*!
   * @brief Gets the pressure over i2c_senz_c from the BMP085
